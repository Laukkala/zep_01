...
public final class UserInterfaceManager {
    ...
    public UserInterfaceManager(final InterpreterContext interpreterContext, Dataset<Row> emptyDataset, List<AvailableFormat> availableFormats) {
        this(new DatasetStore(emptyDataset,availableFormats, interpreterContext), new PerformanceIndicator(interpreterContext), new MessageLog(interpreterContext));
    }
     ...
     */
    public String formatDataset(UIOption uiOption) throws InterpreterException{
